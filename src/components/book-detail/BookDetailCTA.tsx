      ...
      <div className="relative z-10 container mx-auto max-w-5xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-6">
            ...
            <p className="text-muted-foreground font-body text-base leading-relaxed max-w-md mx-auto lg:mx-0">
              Available now in paperback and digital editions. Join Sister
              Francesca on her most righteous adventure yet.
            </p>
